...
const youtube = new YouTube("AIzaSyBGA7JLOGZOOQzxUGdh0hFhBxr4N-JDG1c");
...
const GUILDID = '663621306251739147'; //  تعديل مهم ايدي السيرفر  
const CHANNELID = '663628987985035304'; // تعديل مهم ايدي الروم الصوتي
...
client.user.setGame(`Type ${prefix}play`,"http://twitch.tv/alpha")
 ...
 client.login('NzIwNDUwNzc0OTkxMzcyMzM5.Xuakiw.Nvof7LNYg9sG6C9PFeD9nET1FHo');
...
//تغير الحالة
const developers = ["548061842203738112","","",""] ///تعديل مهم حط هنا ايدي اللي بدك يتحكمو بالحالة
client.on('message', message => {
